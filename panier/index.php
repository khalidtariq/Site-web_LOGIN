                ...
                <div id="titre_principal" >
                                          ...
                                          <img src="images/14.jpg" alt="Avatar" class="image">
                                               <div class="overlay">
                                                      <div class="text">Prix: 30$ <br>
                                                                        Taille:XL/M/S<br> 
                                                                        Solde: 20%
                                                                                         <a href="men.html"><button class="btn-info button1">See More</button></a>
                                          ...
                                          <img src="images/16.jpg" alt="Avatar" class="image">
                                                 <div class="overlay">
                                                        <div class="text">Prix: 30$ <br>
                                                                          Taille:XL/M/S<br> 
                                                                          Solde: 20%
                                                                                        <a href="femme.html"><button class="btn-info button1">See More</button></a>
                                                        </div>
                                                 </div>
                                     </div> 
                                </div>
                    ...
                    <div class="row">
                               <div class="column1">
                                     ...
                                     <div class="container">
                                           <img src="images/40.jpg" alt="Avatar" class="image">
                                                  <div class="overlay">
                                                          <div class="text">Prix: 30$ <br>
                                                                            Taille:XL/M/S<br> 
                                                                            Solde: 20%
